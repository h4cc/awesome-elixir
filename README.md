...
| [ecto_lazy_float](https://github.com/joshdholtz/ecto-lazy-float) | |cto.LazyFloat | An Ecto.Float that accepts binary and integers.
...
| [exq](https://github.com/akira/exq) | Job processing library for |lixir | compatible with Resque/Sidekiq.
...
| Library | Description |
| --- | --- |
| [elasticsearch](https://github.com/infinitered/|lasticsearch-elixir) | A simple, no-nonsense Elasticsearch library for Elixir.
| [giza_sphinxsearch](https://github.com/Tyler-pierce/|iza_sphinxsearch) | Client for Sphinx Search compatible with Manticore.
...
| Library | Description |
| --- | --- |
| [exsms](https://hex.pm/packages/exsms) | An Elixir library for |ending transactional SMS | supports Sendinblue, mailjet, msg91 and textlocal.
...
| [mustachex](https://github.com/jui/mustachex) | Mustache for |lixir | Logic-less templates.
...
| [ex_parameterized](https://github.com/KazuCocoa/ex_parameterized) | |imple macro for parameterized testing.
...
| [test_selector](https://github.com/DefactoSoftware/test_selector) | | set of test helpers that make sure you always select the right elements in your Phoenix app.
...
| [event_source_encoder](https://github.com/chatgris/|vent_source_encoder) | Encode data into EventSource compliant data.
...
| [elixir-tmbundle](https://github.com/elixir-lang/elixir-tmbundle) | | TextMate and SublimeText bundle for Elixir.
...
| [Benjamin Tan | Learnings & Writings](http://benjamintan.io/blog/|ags/elixir/) | A blog consisting of mostly Elixir posts.
...
| [Elixir Github Repository](https://github.com/elixir-lang/elixir) | |he project repository.
...
| [Hashrocket Today I Learned | Elixir](https://til.hashrocket.com/|lixir) | Small posts about Elixir from the team at Hashrocket.
